...
**1. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/07-resources/GOVERNANCE_TRAINING_NOV6.md**
...
**2. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/07-resources/governance_quick_ref.md**
...
**3. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/09-implementation/IMPLEMENTATION_PLAN.md**
- Line 37: `cp docs/01-architecture/STATEFUL_NODE_FEASIBILITY_ASSESSMENT.md \`
...
- Update to: `docs/01-architecture/STATEFUL_NODE_FEASIBILITY_ASSESSMENT.md`
- Line 40: `cp docs/01-architecture/STATEFUL_NODE_EXECUTIVE_SUMMARY.md \`
- Line 41: `   /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/01-architecture/`
- Update to: `docs/01-architecture/STATEFUL_NODE_EXECUTIVE_SUMMARY.md`
...
**4. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/01-architecture/STATEFUL_NODE_EXECUTIVE_SUMMARY.md**
- Line 6: `**Full Analysis:** \`docs/01-architecture/STATEFUL_NODE_FEASIBILITY_ASSESSMENT.md\``
- Line 351: `**Full Analysis:** \`/docs/01-architecture/STATEFUL_NODE_FEASIBILITY_ASSESSMENT.md\` (66 pages)`
...
- Line 189: `- **Executive Summary:** \`docs/01-architecture/STATEFUL_NODE_EXECUTIVE_SUMMARY.md\``
- Line 190: `- **Full Analysis:** \`docs/01-architecture/STATEFUL_NODE_FEASIBILITY_ASSESSMENT.md\` (66 pages)`
...
- Line 383: `- **Full Assessment:** \`docs/01-architecture/STATEFUL_NODE_FEASIBILITY_ASSESSMENT.md\` (66 pages)`
- Line 385: `- **Executive Summary:** \`docs/01-architecture/STATEFUL_NODE_EXECUTIVE_SUMMARY.md\``
- All need update to: `docs/01-architecture/`

**8. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/04-planning/K1_MIGRATION_MASTER_PLAN.md**
...
**2. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/07-resources/GOVERNANCE_TRAINING_NOV6.md**
- Line 54: `| Decisions (ADRs) | \`docs/02-adr/\` | \`ADR-0001-title.md\` |`
- Update to: `docs/02-adr/`

**3. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/07-resources/governance_quick_ref.md**
- Line 29: `| Architecture decisions | \`docs/02-adr/\` | \`ADR-0009-phase-2d1-critical-fixes.md\` |`
- Update to: `docs/02-adr/`

**4. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/09-implementation/IMPLEMENTATION_PLAN.md**
...
- Line 9: `  - docs/04-planning/K1_MIGRATION_MASTER_PLAN.md`
...
**2. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/07-resources/governance_quick_ref.md**
- Line 31: `| Technical analysis | \`docs/05-analysis/\` | \`pattern_codebase_architecture.md\` |`
- Update to: `docs/05-analysis/`
- Line 122: `./tools/governance/add_frontmatter.sh docs/04-planning/myfile.md`
- Update to: `docs/04-planning/myfile.md`

**3. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/09-implementation/IMPLEMENTATION_PLAN.md**
- Line 43: `cp docs/05-analysis/pattern_codebase_architecture.md \`
...
**4. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/05-analysis/PATTERN_ANALYSIS_EXECUTIVE_SUMMARY.md**
...
- Line 378: `- **Executive Summary:** \`docs/05-analysis/PATTERN_ANALYSIS_EXECUTIVE_SUMMARY.md\``
- Line 379: `- **Codebase Architecture:** \`docs/05-analysis/pattern_codebase_architecture.md\``
...
**3. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/07-resources/governance_quick_ref.md**
- Line 32: `| Planning & roadmaps | \`docs/04-planning/\` | \`PHASE_2D1_GRAPH_PARALLEL_MASTER_STRATEGY.md\` |`
- Line 122: `./tools/governance/add_frontmatter.sh docs/04-planning/myfile.md`
- Update all to: `docs/04-planning/`

**4. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/09-implementation/IMPLEMENTATION_PLAN.md**
- Line 32: `   /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/04-planning/`
- Line 46: `cp docs/04-planning/K1_MIGRATION_MASTER_PLAN.md \`
...
**6. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/02-adr/ADR-0005-folder-structure.md**
- Line 9: `  - docs/04-planning/K1_MIGRATION_MASTER_PLAN.md`
- Update to: `docs/04-planning/K1_MIGRATION_MASTER_PLAN.md`
...
**9. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/04-planning/WEEK_1_EXECUTION_KICKOFF.md**
- Line 514: `This kickoff document is ACTIVE. Update daily standup notes in \`docs/04-planning/WEEK_1_STANDUP_LOG.md\` (created separately).`
- Update to: `docs/04-planning/WEEK_1_STANDUP_LOG.md`
...
**7. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/04-planning/NOV_13_DECISION_GATE.md**
...
**1. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/08-governance/GOVERNANCE.md**
- Line 153: `- Templates: \`docs/templates/\``
- Context: Reference to template location

**2. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/04-planning/K1_MIGRATION_MASTER_PLAN.md**
...
**1. /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/04-planning/K1_MIGRATION_MASTER_PLAN.md**
- Line 156: `mkdir -p docs/guides                # How-tos`
...
2. **Documentation vs. Migration Plan Conflict:** The migration plan (`docs/04-planning/K1_MIGRATION_MASTER_PLAN.md`) contains shell commands that reference old paths, but these are historical records of what was done for K1.reinvented migration, not current K1.node1 structure.
...
| /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/04-planning/K1_MIGRATION_MASTER_PLAN.md | adr, architecture, analysis, planning, reports, guides, reference, templates | HIGH |
| /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/09-implementation/IMPLEMENTATION_PLAN.md | adr, planning, reports, architecture, analysis | MEDIUM |
...
| /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/07-resources/GOVERNANCE_TRAINING_NOV6.md | architecture, analysis, adr, planning, reports | MEDIUM |
| /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/07-resources/governance_quick_ref.md | adr, architecture, analysis, planning, reports | MEDIUM |
| /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/04-planning/NOV_13_DECISION_GATE.md | reports | LOW |
| /Users/spectrasynq/Workspace_Management/Software/K1.node1/docs/04-planning/WEEK_1_EXECUTION_KICKOFF.md | planning | LOW |
