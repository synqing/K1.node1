...
- Governance Tools (quick reference): `docs/06-reference/K1NRef_REFERENCE_GOVERNANCE_TOOLS_v1.0_20251108.md`
...
├── K1N_INDEX_v1.0_20251108.md    (Canonical index)
│
├── 01-architecture/              (Tier 1: MASTER)
│   ├── K1NArch_SUMMARY_STATEFUL_NODE_EXECUTIVE_v1.0_20251108.md
│   ├── K1NArch_ASSESSMENT_STATEFUL_NODE_FEASIBILITY_v1.0_20251108.md
│   └── README.md
│
...
│   ├── K1NPlan_PLAN_K1_MIGRATION_MASTER_v1.0_20251108.md
│   ├── K1NPlan_STRATEGY_PHASE_2D1_GRAPH_PARALLEL_MASTER_v1.0_20251108.md
│   └── README.md
│
├── 05-analysis/                  (Tier 2: ACTIVE)
│   ├── K1NAnalysis_SUMMARY_PATTERN_ANALYSIS_EXECUTIVE_v1.0_20251108.md
│   ├── K1NAnalysis_ANALYSIS_PATTERN_CODEBASE_ARCHITECTURE_v1.0_20251108.md
│   └── README.md
│
...
│   ├── K1NRes_GUIDE_GOVERNANCE_TRAINING_NOV6_v1.0_20251108.md
│   ├── K1NRes_GUIDE_BUILDER_EXTENSION_v1.0_20251108.md
│   └── README.md
│
├── 08-governance/                (Governance docs)
│   ├── K1NGov_GOVERNANCE_v1.0_20251108.md
│   └── README.md
│
...
| **Documentation latency** | <1 week discovery | TBD | tab5/K1NAnalysis_INDEX_TAB5_v1.0_20251108.md navigation |
...
1. Check `docs/tab5/K1NAnalysis_INDEX_TAB5_v1.0_20251108.md` (full list, searchable)
