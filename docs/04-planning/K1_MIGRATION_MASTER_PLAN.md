...
mkdir -p docs/{README.md,INDEX.md,DEPRECATION.md}
...
6. **ADR_INDEX.md** - Links to all ADRs with status
...
30. **INDEX.md** - Master navigation document
EOF
```
...
#!/usr/bin/env python3
"""Update documentation statistics in INDEX.md."""
...
def update_index():
    """Update INDEX.md with current statistics."""
