...
### 🧪 QA & Test Engineers
**Primary:** `firmware/firmware_bottleneck_matrix.md` (priorities + effort)
...
├── firmware_bottleneck_matrix.md        ← Priorities (290 lines)
...
├─ Reads firmware_bottleneck_matrix.md for acceptance criteria
...
- **QA:** `firmware/firmware_bottleneck_matrix.md`
...
- [ ] QA has reviewed `firmware_bottleneck_matrix.md`
