...
Location: docs/Conductor/guides/K1NCond_GUIDE_CORELOOP_v1.0_20251108.md

# ❌ WRONG
File: conductor-core-loop-guide.md
Location: docs/Conductor/conductor-core-loop-guide.md
```
...
mv docs/Conductor/guides/K1NCond_GUIDE_OLD_v1.0_20251105.md \
   docs/Conductor/archive/K1NCond_GUIDE_OLD_v1.0_20251105.md
...
Location: docs/Conductor/temp/K1N_DOC_v1.0_DRAFT_20251108.md

# When complete, move to appropriate directory:
mv docs/Conductor/temp/K1N_DOC_v1.0_DRAFT_20251108.md \
   docs/Conductor/guides/K1N_GUIDE_v1.0_20251108.md
```
...
docs/Conductor/K1N_AUDIT_CHECKLIST_v1.0_20251108.md

# Create audit report:
docs/Conductor/K1N_AUDIT_REPORT_v1.0_YYYYMMDD.md
```
...
3. [ ] Copy docs/Conductor/.gitignore
