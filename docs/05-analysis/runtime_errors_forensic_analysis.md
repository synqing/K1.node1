...
**Related:** `build_corruption_root_cause_analysis.md`, commit `dd186d8`, `e4299ee`, `4f111af`
...
- `build_corruption_root_cause_analysis.md` - Compilation error forensics
- `firmware_forensic_analysis.md` - General firmware bottleneck analysis
- `firmware_bottleneck_matrix.md` - Performance bottleneck matrix
