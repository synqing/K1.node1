...
**Related**:
  ...
  - `docs/05-analysis/i2s_audio_freezing_forensic_analysis.md`
...
- **Fix**: Increase to 10-20% for faster adaptation (see `audio_feature_resource_audit.md:213`)
...
**Root Cause** (`i2s_audio_freezing_forensic_analysis.md:128-138`):
```
