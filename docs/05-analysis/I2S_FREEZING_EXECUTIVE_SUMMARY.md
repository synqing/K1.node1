...
- Detailed forensic analysis: `docs/05-analysis/i2s_audio_freezing_forensic_analysis.md`
- JSON forensic report: `docs/05-analysis/i2s_freezing_json_forensic_report.json`
