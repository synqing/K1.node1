...
- **Full Root Cause Analysis:** `docs/05-analysis/compilation_error_root_cause_analysis.md`
- **Error Timeline:** `docs/05-analysis/compilation_error_timeline_and_impact.md`
- **Migration Decision:** `docs/04-planning/esp_idf_api_migration_decision.md`
