...
|----------|---------|--------|--------------|
| **[Executive Summary](I2S_FREEZING_EXECUTIVE_SUMMARY.md)** | High-level overview & actionable fixes | 2 pages | 5 min |
| **[Forensic Analysis](i2s_audio_freezing_forensic_analysis.md)** | Deep technical investigation with evidence | 8 pages | 20 min |
| **[JSON Report](i2s_freezing_json_forensic_report.json)** | Structured forensic findings | 1 file | 10 min |
| **[Diagnostic Guide](I2S_DIAGNOSTIC_AND_VERIFICATION.md)** | How to verify root causes & test fixes | 6 pages | 15 min |
...
1. Run diagnostic test (see [Diagnostic Guide](I2S_DIAGNOSTIC_AND_VERIFICATION.md))
...
docs/
├─ 05-analysis/
│  ├─ i2s_audio_freezing_forensic_analysis.md      (MAIN: detailed forensic findings)
│  ├─ i2s_freezing_json_forensic_report.json        (Structured: machine-readable report)
│  ├─ I2S_FREEZING_EXECUTIVE_SUMMARY.md             (Quick: overview + actionable fixes)
│  ├─ I2S_DIAGNOSTIC_AND_VERIFICATION.md            (Practical: how-to guide)
│  └─ I2S_ANALYSIS_INDEX.md                         (This file: navigation guide)
│
firmware/
├─ src/
│  ├─ audio/
