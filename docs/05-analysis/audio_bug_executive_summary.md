...
- **Forensic Analysis**: `docs/05-analysis/audio_data_flow_forensic_analysis.md`
- **Visual Diagrams**: `docs/05-analysis/audio_pipeline_visual_diagram.md`
- **Previous Analyses**:
  - `docs/05-analysis/i2s_audio_freezing_forensic_analysis.md` (cache coherency hypothesis)
  - `docs/05-analysis/audio_pipeline_forensic_analysis.md` (synchronization bug identified)
