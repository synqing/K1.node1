...
- ✅ Integration Guide: `docs/03-guides/orkes-integration-guide.md`
...
├── docs/
│   └── 03-guides/
│       └── orkes-integration-guide.md  # NEW - Integration guide
│
├── webapp/
...
- **Integration Guide:** [docs/03-guides/orkes-integration-guide.md](docs/03-guides/orkes-integration-guide.md)
