...
- Security Remediation: buffer overflow, race condition, globals, initialization, bounds checks. See fixes: `docs/06-reference/phase_a_security_fixes_reference.md`.
...
- Reference: follow code snippets and tests in `docs/06-reference/phase_a_security_fixes_reference.md`.
...
## Artifacts & Links
- Master: `docs/09-reports/MASTER_SYNTHESIS_REPORT.md`
- Validation: `docs/09-reports/security_fix_validation.md` (populate with proofs)
- Spec: `docs/04-planning/phase_0_beat_phase_exposure_plan.md`
- Snippets: `docs/06-reference/phase_0_implementation_snippets.md`
 - Reference: `docs/07-resources/beat_phase_quick_reference.md`
 - Security Fixes Reference: `docs/06-reference/phase_a_security_fixes_reference.md`
