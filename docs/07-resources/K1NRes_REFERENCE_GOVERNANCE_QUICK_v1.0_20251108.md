...
| Technical analysis | `docs/05-analysis/` | `K1NAnalysis_ANALYSIS_PATTERN_CODEBASE_ARCHITECTURE_v1.0_20251108.md` |
| Planning & roadmaps | `docs/04-planning/` | `K1NPlan_STRATEGY_PHASE_2D1_GRAPH_PARALLEL_MASTER_v1.0_20251108.md` |
| Phase reports | `docs/09-reports/` | `phase_2d1_validation_report.md` |
| Quick refs & templates | `docs/07-resources/` | `K1NRes_REFERENCE_GOVERNANCE_QUICK_v1.0_20251108.md` |
