...
export interface IDLQService {
   ...
   */
  cleanupDLQ(retentionDays: number): Promise<ServiceResult<{ deleted: number }>>;
}
...
export interface ISchedulerService {
  ...
  getExecutionHistory(
    ...
    limit?: number,
    offset?: number
  ): Promise<ServiceResult<ExecutionHistory[]>>;
   ...
   */
  cleanupExecutionHistory(retentionDays: number): Promise<ServiceResult<{ deleted: number }>>;
}
